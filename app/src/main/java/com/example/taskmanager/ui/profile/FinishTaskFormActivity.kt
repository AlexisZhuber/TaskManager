...
import com.example.taskmanager.databinding.ActivityFinishTaskFormBinding
import com.example.taskmanager.model.STask
import com.example.taskmanager.ui.profile.adapters.PhotoAdapter
import com.example.taskmanager.viewmodel.FinishTaskFormViewModel
import java.util.Locale

class FinishTaskFormActivity : AppCompatActivity() {

    private lateinit var binding: ActivityFinishTaskFormBinding
    private val viewModel: FinishTaskFormViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFinishTaskFormBinding.inflate(layoutInflater)
        ...
        binding.buttonSubmit.setOnClickListener {
            ...
            val task: STask? = intent.getParcelableExtra("task")
            task?.let {
                showLoading(true)
